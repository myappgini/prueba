...
function todos_insert(&$error_message = '') {
	...
	if(!empty($_REQUEST['SelectedID'])) todos_copy_children($recID, $_REQUEST['SelectedID']);
...
function todos_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$combo_dateInit->MinYear = 1900;
	$combo_dateInit->MaxYear = 2100;
	...
	$combo_dateEnd->MinYear = 1900;
	$combo_dateEnd->MaxYear = 2100;
	...
	$templateCode .= loadView('todos-ajax-cache', array('rdata' => $rdata, 'jdata' => $jdata));
