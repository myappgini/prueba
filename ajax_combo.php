...
*/
	...
	$lookups = array(
		...
		'salary' => array(
			'contacto' => array(
				'parent_table' => 'contacto',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`contacto`.`name`) || CHAR_LENGTH(`contacto`.`user`), CONCAT_WS(\'\', `contacto`.`name`, \' - \', `contacto`.`user`), \'\')',
				'parent_from' => '`contacto` ',
				'filterers' => array(),
				'custom_query' => '',
			...
			'date' => array(
				'parent_table' => 'contacto',
				'parent_pk_field' => 'id',
				'parent_caption' => 'if(`contacto`.`date`,date_format(`contacto`.`date`,\'%d/%m/%Y\'),\'\')',
				'parent_from' => '`contacto` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
