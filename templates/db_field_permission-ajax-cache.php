...
<script>
	$j(function() {
		...
		var data = {
			groupID: <?php echo json_encode(array('id' => $rdata['groupID'], 'value' => $rdata['groupID'], 'text' => $jdata['groupID'])); ?>,
			table_field: <?php echo json_encode(array('id' => $rdata['table_field'], 'value' => $rdata['table_field'], 'text' => $jdata['table_field'])); ?>
		};
