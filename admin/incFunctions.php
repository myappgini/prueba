	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'view_membership_groups' => ['View mebership group', '', 'table.gif', 'None'],
			'todos' => ['Todos', '', 'table.gif', 'None'],
		];
		...
		if($schema === null) {
			...
			$schema = [
				...
				'salary' => [
					...
					'date' => [
						'appgini' => "INT UNSIGNED NULL DEFAULT '1'",
						'info' => [
							'caption' => 'Proxima fecha de pago',
							'description' => '',
						],
					],
				],
				...
				'tmp_tables_fields' => [
					'table_filed' => [
						'appgini' => "VARCHAR(200) NOT NULL PRIMARY KEY",
						'info' => [
							'caption' => 'Table filed',
							'description' => '',
						],
